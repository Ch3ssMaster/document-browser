  ...
  return (
    ...
    >
      ...
      >
        ...
        <Menu.Divider />
        <SubMenu key="sub4" title="Grupo">
          <Menu.Item key="14">Grupo 1</Menu.Item>
          <Menu.Item key="15">Grupo 2</Menu.Item>
          <Menu.Item key="16">Grupo 3</Menu.Item>
          <Menu.Item key="17">Grupo 4</Menu.Item>
        </SubMenu>
        <Menu.Divider />
        <SubMenu key="sub5" title="Date Range">
          <Menu.Item key="17">Range 1</Menu.Item>
          <Menu.Item key="18">Range 2</Menu.Item>
          <Menu.Item key="19">Range 3</Menu.Item>
          <Menu.Item key="20">Range 4</Menu.Item>
        </SubMenu>
      </Menu>
